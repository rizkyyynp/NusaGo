    ...
    return (
        <section className="bg-zinc-100 py-8 pl-16 pr-2 lg:px-8">
            <div className="flex items-center mb-2">
                ...
                <h2 className="text-2xl font-bold text-primary">Our Categories</h2>
            </div>
            <p className="text-primary mb-6">Find your perfect escape</p>
            <div>
                ...
                {!hideButton && (
                    <div className="mt-8 text-center">
                        <button onClick={handleToggle} className="bg-zinc-100 text-primary border-2 border-secondary py-2 px-4 rounded-full hover:bg-secondary hover:border-2 hover:border-third hover:text-zinc-100 transition-all duration-100 ease-in-out">
