    ...
    return (
        <section className={`${darkMode ? 'bg-dark1 shadow-BS4' : 'bg-secondary-gradient'} p-8`}>
            <div className="flex items-center mb-4">
                <FaPlaneDeparture className={`${darkMode ? 'text-secondary' : 'text-zinc-100'} mr-2 text-xl`} />
                <h2 className={`text-2xl lg:text-3xl font-bold font-podkova ${darkMode ? 'text-secondary' : 'text-zinc-100'}`}>Discover Diverse Activities</h2>
            </div>
                            ...
                            <div className="bg-zinc-100 rounded-lg overflow-hidden  cursor-pointer shadow-lg">
                                ...
                                <div className="p-1 flex justify-between items-end">
                                    <div>
                                        ...
                                        <p className="text-primary font-nunito flex items-center"><FaLocationDot className="text-primary mr-1" />{item.city}</p>
                                        <p className="text-primary font-nunito flex items-center"><FaLocationDot className="text-primary mr-1" />{item.province}</p>
                                    </div>
